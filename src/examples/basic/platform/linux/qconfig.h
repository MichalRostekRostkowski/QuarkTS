 ...
 **/
    ...
    #define Q_FSM_PS_SIGNALS_MAX        ( 3 )       /**< Used in Publish/Subscribe module to reserve buffer for signal types that FSMs can subscribe to*/
    #define Q_FSM_PS_SUB_PER_SIGNAL_MAX ( 3 )       /**< If Q_PS_SIGNALS_MAX is declared to be greater then 0 then this define indicates how many FSMs can subscribe to a particular signal type*/
