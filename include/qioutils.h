 ...
 **/
    ...
    */
    ...
    /**
    * @brief Converts an unsigned integer value to a null-terminated string
    * using the 16 base and stores the result in the array given by @a str
    * parameter. @a str should be an array long enough to contain any possible
    * value.
    * @param[in] value Value to be converted to a string.
    * @param[out] str Array in memory where to store the resulting string.
    ...
    */
    ...
    /**
    * @brief Converts a qBool_t value to a null-terminated string. Input is
    * considered true with any value different to zero (0).
    * The argument @a str should be an array long enough to contain the output
    * @param[in] num Value to be converted to a string.
    * @param[out] str  Array in memory where to store the resulting
